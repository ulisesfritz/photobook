# Replace the content of /rspec/models/post_rspec.rb with the following
...
# Edit the file _/spec/models/post_spec.rb_and add the following lines in the context of "with invalid attributes"
